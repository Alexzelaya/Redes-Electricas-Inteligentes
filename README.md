...
Meta: comprender los retos de la transición energética y cómo las mediciones inteligentes permiten observar la dinámica de la red eléctrica.
Temas y actividades:
...
Meta: explorar cómo las mediciones inteligentes y las herramientas de análisis de datos pueden utilizarse para identificar eventos y apoyar el monitoreo de la red eléctrica.
Temas y actividades:
...
Meta del día: aplicar herramientas de ciencia de datos e inteligencia artificial para analizar series de tiempo, clasificar eventos eléctricos y evaluar la confiabilidad de los resultados.
